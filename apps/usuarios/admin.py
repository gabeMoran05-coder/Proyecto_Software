...
from .models import AutomatizacionCorreo, NotificacionSistema, Usuario
...
@admin.register(AutomatizacionCorreo)
class AutomatizacionCorreoAdmin(admin.ModelAdmin):
    list_display = ['nombre', 'id_usuario', 'tarea', 'seccion_reporte', 'activa', 'hora_envio', 'dia_semana', 'dia_mes', 'ultimo_envio']
    list_filter = ['activa', 'tarea', 'seccion_reporte', 'id_usuario']
    search_fields = ['nombre', 'clave', 'id_usuario__usuario', 'id_usuario__email']
