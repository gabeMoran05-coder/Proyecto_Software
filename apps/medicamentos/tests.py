...
class InventarioTests(TestCase):
    ...
    def test_lote_con_cero_dias_para_caducar_es_caduco(self):
        ...
        self.assertEqual(self.lote.dias_para_caducar, 0)
        self.assertEqual(self.lote.estado_caducidad, Lote.CADUCIDAD_ROJO)
        self.assertEqual(self.lote.estado_caducidad_display(), 'Caduco')
