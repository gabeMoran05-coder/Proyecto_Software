...
urlpatterns = [
    ...
    path('<int:pk>/stock-minimo/', views.medicamento_stock_minimo, name='medicamento_stock_minimo'),
    path('<int:pk>/alerta-caducidad/', views.medicamento_alerta_caducidad, name='medicamento_alerta_caducidad'),
    ...
    path('lotes/notificaciones/', views.lote_notificaciones, name='lote_notificaciones'),
    path('lotes/<int:pk>/notificacion/descartar/', views.lote_descartar_notificacion, name='lote_descartar_notificacion'),
    ...
    path('lotes/<int:pk>/ajuste/', views.lote_ajuste_inventario, name='lote_ajuste_inventario'),
    path('lotes/<int:pk>/conteo/', views.lote_conteo_fisico, name='lote_conteo_fisico'),
