...
def app_martin(request):
    """Mini app movil independiente para Martin, sin inventario precargado."""
    return render(request, 'medicamentos/app_martin.html')

def qr_martin(request):
    data = request.GET.get('data', '')
    if not data:
        return HttpResponseBadRequest('Falta data')
